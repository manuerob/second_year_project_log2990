...
Pas de commentaire TODO apres merge au dev.

terminer les variables observables avec un $.

les commits doivent etre ecris en anglais

les commits doivent etre de cette forme: type_sous-type

commencer chaque commit [name-of-branch]
...
`/api/date` renvoie l'heure et la date d'aujourd'hui en faisant un appel à une API externe (worldclockapi)
